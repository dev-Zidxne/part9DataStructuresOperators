...
console.log('a+console.log(announcement.replaceAll('door', 'gate'));dane Innis'.split(' '));

const [firstName, lastName] = 'Zidane Innis'.split(' ');
...
console.log(maskCreditCard(52483562));
console.log(maskCreditCard(4665454761651));
console.log(maskCreditCard('4665454761651'));
...
planeInLine(5)console.log(announcement.replaceAll('door', 'gate'));= 'TAP Air Portugal';
...
console.log(new String('Zidane'));
console.log(typeof new String('Zidane'));
console.log(typeof new String('Zidane').slice(1));
...
console.log(gameEvents); // minutes 64 is gone

// 3.
const average = 90 / gameEvents.size; // could have also put this into the template literal console.log(`An event happened on average, every ${90 / gameEvents.size} minutes.`);
...
const question = new Map([
  ['question', 'What is the best programmiong language in the world'],
  [1, 'C'],
  [2, 'Java'],
  [3, 'JavaScript'],
  ['correct', 3],
...
console.log(rest.set(2, 'Lisbon, Poprtugal'));
...
console.log(new Set('zidaneinnis').size);
...
console.log('-------------OR-----------');
// Use ANY data type, return ANY data type, short-cirucuiting
